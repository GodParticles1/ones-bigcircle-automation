...
`migration/browser-bridge-public-v040` — configuration-driven read-only Browser Bridge candidate. Static syntax/redaction tests pass locally; independent semantic/CI review is required before integration.
