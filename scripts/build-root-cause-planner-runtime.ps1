param([string]$OutputDir = (Join-Path $PSScriptRoot "..\dist-root-cause-planner"))
$ErrorActionPreference = "Stop"
$RepoRoot = (Resolve-Path (Join-Path $PSScriptRoot "..")).Path
$Name = "ones-root-cause-planner-runtime-v0.1.0"
...
Copy-Item (Join-Path $RepoRoot "release\root-cause-planner-runtime-v0.1.0\run-planner.ps1") (Join-Path $Stage "run-planner.ps1")
Copy-Item (Join-Path $RepoRoot "release\root-cause-planner-runtime-v0.1.0\README.md") (Join-Path $Stage "README.md")
...
Write-Host "ROOT_CAUSE_PLANNER_RUNTIME_PACKAGE_PASS"
